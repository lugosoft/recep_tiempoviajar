<?php
	...
	function interfaz($operacion,   $param1='<NULL>', $param2='<NULL>',
		...
		$new_loc->name = "Luis";
		$new_loc->id = "452";
		$new_loc->latitude = "259";
		$new_loc->longitude = "285";
	...
	$server = new SoapServer("http://localhost/receptivos/webservice/wsdl/service2.wsdl");
	$server->addFunction("interfaz"); 
	$server->handle();

/*
http://www.fischco.org/blog/2011/3/26/php-soapserver-objects-arrays-and-encoding.html
http://foro.elhacker.net/php/webservice_problema_el_retornar_un_dato_con_un_soapserverphp-t316854.0.html
http://www.dotvoid.com/2008/10/soap-structures-in-php/
https://bugs.php.net/bug.php?id=31869
*/	
