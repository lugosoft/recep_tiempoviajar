...
<script>
	function reporteIN(){
		...
		xajax_sacarReporteX('queryReporteVentaTour',fecini,fecfin,selServicio,selPro,horaTour,selCliente, ofiRep);
	};
...
<div id="tablaDatosReporte" >
	...
	<td width="25%" align="right">
		<p id="textoRep" class="textoFormReporte2">Tours Confirmados en <?php echo $_SESSION["oficinaname"]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	</td>
	</tr>
	</table>
	</form>
