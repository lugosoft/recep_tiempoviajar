<?php
	...
	if($clienteUsu == ''){
		echo"<script>var repClienteUsu = 'queryReporteConsecReserva2'; var clienteUsu = '$clienteUsu';</script>";
	}
	else{
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					<?php printValueXML('formTablaDatosReporte','fechaLlegaIni'); ?> 
	...
	<td width="30%" align="right">
		<p id="textoRep" class="textoFormReporte2">Consecutivos de Reservas v2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	</td>
	</tr>
	</table>
	</form>
