...
<script>
	function estadisticaPasajeros(){
		...
		if(selPeriodo == 'rango'){
			...
			xajax_sacarReporteX('queryEstadisticaResRango',fecini,fecfin);			
		}
		...
		if(selPeriodo == 'mensual'){
			...
			xajax_sacarReporteX('queryEstadisticaResMensual',ano);			
		}
	...
	function getDatosReporte(){
		...
		if(document.formTablaDatosReporte.selPeriodo.value == 'rango'){
			texto = 'Numero de Pasajeros&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desde: ' + document.formTablaDatosReporte.fechaIni.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasta: ' + document.formTablaDatosReporte.fechaFin.value;
		}
		if(document.formTablaDatosReporte.selPeriodo.value == 'mensual'){
			texto = 'Numero de Pasajeros&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ano: ' + document.formTablaDatosReporte.ano.value;
		}
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					...
					&nbsp;&nbsp;
					<input type="button" style="display:none;" onClick="estadisticaPasajeros();" id="btnConReporte" name="btnConReporte" value="<?php printValueXML('formTablaDatosReporte','btnConReporte'); ?>" class="boton btnConReporte" onmouseover="className='botonHover btnConReporte'" onmouseout="className='boton btnConReporte'" />
				</p>
				</td>	
			</tr>							
		</table>	
	...
	<td width="30%" align="right">
		<p id="textoRep" class="textoFormReporte2">Estad&iacute;stica Pasajeros en Reservas</p>
	</td>
	</tr>
	</table>
	</form>
