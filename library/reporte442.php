...
<script>
	function estadisticaServicio(){
		...
		if(selPeriodo == 'rango'){
			r = verificarCamposObligatorios(new Array(selServicio,getValueXML('formTablaDatosReporte','selServicio')),
			...
			xajax_sacarReporteX('queryEstadisticaSerRangoNac',selServicio,fecini,fecfin);			
		}
		...
		if(selPeriodo == 'mensual'){
			...
			xajax_sacarReporteX('queryEstadisticaSerMensualNac',selServicio,ano);			
		}
	...
	function getDatosReporte(){
		...
		if(document.formTablaDatosReporte.selPeriodo.value == 'rango'){
			texto = 'Servicio: ' + document.formTablaDatosReporte.selServicio.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desde: ' + document.formTablaDatosReporte.fechaIni.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasta: ' + document.formTablaDatosReporte.fechaFin.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agrupado por: Nacionalidad';
		}
		if(document.formTablaDatosReporte.selPeriodo.value == 'mensual'){
			texto = 'Servicio: ' + document.formTablaDatosReporte.selServicio.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ano: ' + document.formTablaDatosReporte.ano.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agrupado por: Nacionalidad';
		}
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					...
					&nbsp;&nbsp;
					<input type="button" style="display:none;" onClick="estadisticaServicio();" id="btnConReporte" name="btnConReporte" value="<?php printValueXML('formTablaDatosReporte','btnConReporte'); ?>" class="boton btnConReporte" onmouseover="className='botonHover btnConReporte'" onmouseout="className='boton btnConReporte'" />
				</p>
				</td>	
			</tr>							
		</table>	
	...
	<td width="30%" align="right">
		<p id="textoRep" class="textoFormReporte2">Estad&iacute;stica Pax por Servicio</p>
	</td>
	</tr>
	</table>
	</form>
