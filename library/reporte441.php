...
?>
<script>
	function estadisticaNacionalidad(){
		var r = '';
		...
		if(selPeriodo == 'rango'){
			r = verificarCamposObligatorios(new Array(selNac,getValueXML('formTablaDatosReporte','selNac')),
			...
			xajax_sacarReporteX('queryEstadisticaNacRango'+selClasificar,selNac,fecini,fecfin);			
		}
		...
		if(selPeriodo == 'mensual'){
			...
			xajax_sacarReporteX('queryEstadisticaNacMensual'+selClasificar,selNac,ano);			
		}
	...
	function getDatosReporte(){
		...
		if(document.formTablaDatosReporte.selPeriodo.value == 'rango'){
			texto = 'Nac: ' + document.formTablaDatosReporte.selNac.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desde: ' + document.formTablaDatosReporte.fechaIni.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasta: ' + document.formTablaDatosReporte.fechaFin.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agrupada por: ' + document.formTablaDatosReporte.selClasificar.value;
		}
		if(document.formTablaDatosReporte.selPeriodo.value == 'mensual'){
			texto = 'Nac: ' + document.formTablaDatosReporte.selNac.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ano: ' + document.formTablaDatosReporte.ano.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Agrupada por: ' + document.formTablaDatosReporte.selClasificar.value;
		}
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte">
					...
					<select name="selNac" id="selNac" class="selSelNac">
				...
				<p class="textoFormReporte"> 
					...
					<input type="button" style="display:none;" onClick="estadisticaNacionalidad();" id="btnConReporte" name="btnConReporte" value="<?php printValueXML('formTablaDatosReporte','btnConReporte'); ?>" class="boton btnConReporte" onmouseover="className='botonHover btnConReporte'" onmouseout="className='boton btnConReporte'" />
				</p>
				</td>	
			</tr>							
		</table>	
	...
	<td width="30%" align="right">
		<p id="textoRep" class="textoFormReporte2">Estad&iacute;stica NumPax por Nacionalidad</p>
	</td>
	</tr>
	</table>
	</form>
