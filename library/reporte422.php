...
<script>
	function reporteINMes(){
		...
		xajax_sacarReporteX('queryReporteINMes',selAno+selMes);
	};
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" onClick="reporteINMes();" id="btnConReporte" name="btnConReporte" value="<?php printValueXML('formTablaDatosReporte','btnConReporte'); ?>" class="boton btnConReporte" onmouseover="className='botonHover btnConReporte'" onmouseout="className='boton btnConReporte'" />
				</p>
				</td>	
			</tr>							
		</table>	
	...
	<td width="30%" align="right">
		<p id="textoRep" class="textoFormReporte2">Reporte Transfer-IN Mensual&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	</td>
	</tr>
	</table>
	</form>
