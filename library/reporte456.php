...
<script>
	function reporteIN(){
		...
		xajax_sacarReporteX('queryRepContactos',fecini,fecfin);
	};
	
	function getDatosReporte(){
		var texto = '';
		texto = 'Registrados/Actualizados Desde: ' + document.formTablaDatosReporte.fechaIni.value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hasta: ' + document.formTablaDatosReporte.fechaFin.value;
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					Registrados/Actualizados <?php printValueXML('formTablaDatosReporte','fechaIni'); ?> 
					<input type="text" id="fechaIni" name="fechaIni" value="<?php printVar(getFecha0101yyyy());?>" class="cajaFechaIni" onKeyUp="pasarFocoOnEnter(event,this.id, document.formTablaDatosReporte.fechaFin.id)" />
	...
	<td width="25%" align="right">
		<p id="textoRep" class="textoFormReporte2">Base Datos de Contactos&nbsp;&nbsp;&nbsp;</p>
	</td>
	</tr>
	</table>
	</form>
