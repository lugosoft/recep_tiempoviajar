...
<script>
	function reporteOUT(){
		...
		xajax_sacarReporteX('queryReporteOUT',fecini,fecfin,nroVlo);
	};
...
<div id="tablaDatosReporte" >
		...
		<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">					
			<tr>
				...
				<p class="textoFormReporte"> 
					...
					<input type="button" onClick="reporteOUT();" id="btnConReporte" name="btnConReporte" value="<?php printValueXML('formTablaDatosReporte','btnConReporte'); ?>" class="boton btnConReporte" onmouseover="className='botonHover btnConReporte'" onmouseout="className='boton btnConReporte'" />
				</p>
				</td>	
			</tr>							
		</table>	
	...
	<td width="25%" align="right">
		<p id="textoRep" class="textoFormReporte2">Reporte Transfer-OUT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	</td>
	</tr>
	</table>
	</form>
