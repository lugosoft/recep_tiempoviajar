...
//******************************************************************************
	...
	*/
    ...
    function scwSetDefaultLanguage(lang)
        {
			if (lang == 'en'){
				 try
					{scwSetLanguage();}
				 ...
				 try
					...
					{// Español
					 ...
					 scwInvalidDateMsg      = 'La fecha entrada no es válida.\n';
					 scwOutOfRangeMsg       = 'La fecha entrada esta fuera de rango.';
					 scwDoesNotExistMsg     = 'La fecha entrada no existe.';
					 scwInvalidAlert        = ['Fecha no valida (',') ignorada.'];
					 scwDateDisablingError  = ['Error ',' no es unobjeto fecha.'];
					 scwRangeDisablingError = ['Error ',
    ...
    //scwDisabledDates[0] = [new Date(2021,0,1),new Date(2021,6,23)];
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSource,langCal)
